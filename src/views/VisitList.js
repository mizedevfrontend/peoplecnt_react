...
const VisitList = () => {
  ...
  const [activeTab, setActiveTab] = useState("today"); // useState("daily"); // 현재 활성 탭
      ...
      <div className="content">
        <div className="tablebox">
          ...
          <div className="info">
            총
            <span>
              {activeTab === "daily" ? dailyTotalCount : authTotalCount}
            </span>
            <span>{activeTab === "daily" ? "명" : "건"}</span>
          </div>
          <div className="table-container">
            <table>
              ...
              <tbody>
                ...
                {(activeTab === "daily" ? dailyResults : authResults).map(
                  (result, index) => (
                    <tr key={index}>
                      {activeTab === "daily" ? (
                        <>
